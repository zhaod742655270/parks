...
<head>
    ...
    <script type="text/javascript" src="../resources/script/officesys/warehouseOutput.js"></script>
    <style type="text/css">
        #warehouseDlg td {
            height: 30px;
            padding-left: 5px;
...
<body>
    ...
    <div id="warehouseDlg" class="easyui-dialog" style="padding: 10px" modal="true"
        ...
        <form id="addWarehouse" method="post">
            <table>
                <tr>
                    <td style="height: 5px;"><input type="hidden" id="id" name="warehouseOutput.id"></td>
                    <td><input type="hidden" id="jsonAllRows" name="jsonAllRows"/></td>
                </tr>

                <tr>
                    <td class="tdLeft"><label>出库单号：</label></td>
                ...
                <tr>
                    ...
                    <td class="tdRight"><input id="application" class="easyui-combobox" name="warehouseOutput.applicationID"
                                               data-options="editable:false"></td>
                </tr>

                <tr>
                    <td class="tdLeft"><label>录出人：</label></td>
                    <td class="tdRight"><input id="recordPerson" class="easyui-combobox" name="warehouseOutput.recordPersonID"
                                               data-options="editable:false"></td>

                    <td class="tdLeft"><label>录出日期：</label></td>
                    <td class="tdRight"><input id="recordDate" class="easyui-datebox" name="warehouseOutput.recordDate"></td>
                </tr>
    ...
    <div id="warehouseDlg-button">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-ok" onclick="saveWarehouseOutput()">保存</a>
    ...
    <div id="productSelect-toolbar">
        <div style="height: 30px">
            <form id="queryProductSelect-form">
                <table>
                    <tr>
                        <td><label>简称</label> &nbsp;<input id="nameSelectQuery" style="width: 110px"/>&nbsp;</td>
    ...
    <div id="approveDlg" class="easyui-dialog" style="padding: 10px" modal="true" closed="true" buttons="#approveDlg-button">
        <form id="addApprove">
            <table>
                <tr>
                    <td style="height: 5px;"><input type="hidden" id="approveId" name="warehouseOutput.id"/></td>
                </tr>

                <tr>
                    <td class="tdLeft"><label>批准人：</label></td>
                    <td class="tdRight"><input id="examinePerson" class="easyui-combobox" name="warehouseOutput.examinePersonID"></td>

                    <td class="tdLeft"><label>批准日期：</label></td>
                    <td class="tdRight"><input id="examineDate" class="easyui-datebox" name="warehouseOutput.examineDate"></td>
                </tr>
            </table>
        </form>
    </div>
