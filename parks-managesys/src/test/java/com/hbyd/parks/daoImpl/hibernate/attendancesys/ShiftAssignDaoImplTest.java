...
public class ShiftAssignDaoImplTest {
    ...
    @Test
    @Transactional
    public void testUsedWithinShiftAssign() throws Exception {
        boolean b = shiftAssignDao.usedWithinShiftAssign("821bc4dd-b919-4150-a90a-4387054a929d");
        Assert.assertTrue(b);
    }
}