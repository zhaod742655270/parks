...
public class QuotationDTO extends BaseDTO {
    ...
    //项目表
    private QuotationProjectDTO quotationProjectDTO;

    public String getProjectIdFK() {
        return projectIdFK;
    }

    public void setProjectIdFK(String parentProjectID) {
        this.projectIdFK = parentProjectID;
    }
    ...
    public QuotationProjectDTO getQuotationProjectDTO() {
        return quotationProjectDTO;
    }

    public void setQuotationProjectDTO(QuotationProjectDTO quotationProjectDTO) {
        this.quotationProjectDTO = quotationProjectDTO;
    }
}
