 ...
 */
@Entity
@Table(name = "oa_design_quotation")
@Audited
public class Quotation extends RecoverableEntity {
    //所属项目ID
    ...
    //项目表
    @ManyToOne
    private QuotationProject quotationProject;
    ...
    public QuotationProject getQuotationProject() {
        return quotationProject;
    }

    public void setQuotationProject(QuotationProject quotationProject) {
        this.quotationProject = quotationProject;
    }
}